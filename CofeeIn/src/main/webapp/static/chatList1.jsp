...
function openChat(){
	...
	$('#btnCount').attr("style", "visibility: hidden")
}
//////////////////////////////////
function AllUser(){
...
///////////////////////////웹소켓 파트///////////////////////////////////////
	...
	function myFunction(){ // keyup 일어날떄마다
		var text = $('#text').val();
		$.ajax({  // 길이만큼 반복하면 ajax
			url : "/coffee/selectChatUserList/" + text, // 유저ID로 실시간 검색
				method : "GET",
				async:false,
				success : function(data){
					var result = data.data;
...
<div class="chat_list_wrap">
    ...
    <div class="search">
        <input type="text" placeholder="채팅방 이름, 참여자 검색" id="text" onkeyup="myFunction();"/>
    </div>
    <div class="list">
        <ul id="result">
