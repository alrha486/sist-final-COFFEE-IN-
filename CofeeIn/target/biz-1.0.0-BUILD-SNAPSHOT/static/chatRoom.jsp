...
function sendMessage() {
    ...
    $.ajax({ // IF문 조건 다 거치면 회원가입 처리 AJAX 실행
		url : "/coffee/insertUserMessage", // 유저의 메시지 DB에 insert
		dataType : "json",
		method : "POST",
...
function onMessage(evt) { // 메시지 받으면 
	...
	ocontainer_msg.scrollTop = ocontainer_msg.scrollHeight;
	if(realUserid != 'wlsdnd123'){
		playChatBot(realText); // 일단 보내
	} 
