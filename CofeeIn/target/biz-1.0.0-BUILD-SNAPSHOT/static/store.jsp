			...
			if(count == 0){
				...
				for(var i = 0 ; i < count ; i++){
					...
					var num = i;
						...
						slist += "<td><a href='javascript:showMap(" + num + ");' style='cursor: pointer;'>";
    		...
    		success : function(anystore){
    			...
    			if(countstore == 0){
	    			...
	    			for(var i = 0 ; i < countstore ; i++){
						...
						anylist += "<td><a href='javascript:showMap(" + num + ");' style='cursor: pointer;'>";
...
<body>
    ...
    <div class="search_bbs srch_shop mt20">
					<select id="region" name="region" style="width:100px" class="ml15" onchange="javascript:changing(this.value);">
					...
					<select id="gugun" name="gugun" style="width:100px">
						<option value="">구/군 선택</option>
				      
					</select>
					
					<input id="shopname" name="shopname" class="inp_txt ml15" style="width:190px" type="text" value="">
					<button onclick="search();" alt="검색">검색</button>
				</div>
	<br/><br/><br/><br/>			
