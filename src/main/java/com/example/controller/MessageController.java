...
public class MessageController {
	...
	@RequestMapping(value = "/selectChatUserList/{text}", method = RequestMethod.GET)
	@ResponseBody
	public Map selectChatUserList(@PathVariable String text) {
		Map<String,Object> map = new HashMap<String,Object>();
		String text1 = "%" + text+ "%";
		
		map.put("text", text1);
		memberService.selectChatUserList(map); 
		List<MessageVO> list = (List<MessageVO>)map.get("results");
