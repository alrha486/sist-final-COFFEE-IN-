<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <script src="static/resources/vendor/datatables/js/jquery.dataTables.min.js"></script>
    <script src="static/resources/vendor/datatables-plugins/dataTables.bootstrap.min.js"></script>
    <script src="static/resources/vendor/datatables-responsive/dataTables.responsive.js"></script>
