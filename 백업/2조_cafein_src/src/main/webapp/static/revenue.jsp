...
<div class="row">
    <div class="col-lg-12">
       <h3 class="page-header" id="result1">상품 매출 그래프</h3>
    </div>
</div>
     
<div class="row">
	<div style="float: right;margin-right: 350px">
		<button type="button" class='btn btn-success' onclick="today();">오늘</button>
		<button type="button" class='btn btn-danger' onclick="week();">이번 주</button>
	</div>
 </div>
